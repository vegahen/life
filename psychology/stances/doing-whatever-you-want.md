...
[Humans](/media/tv-mini-series/ascent-of-man.md) are built to [survive](/psychology/values/value-1.md). In order to survive, the brain is built to [solve problems perfectly](/experiences/people/-/tweets/richest-man-in-the-world.md). In order to solve problems perfectly, we need [passion](https://en.wikipedia.org/wiki/David_Hume).
...
> `SSH`: I should not bite people

That dog is [delusional](/psychology/theories/illusion-of-evil.md), but who the hell can blame them? The dog is not smart enough to realize that biting is the reason for their trauma.

Likewise, late-stage capitalism [traumatizes](/psychology/stances/capitalism.md) people. And people are either not smart enough to realize that it was their own fault because

> `SSH`: I need to pull myself up by the bootstraps

> `SSH`: I need to get myself together

> `SSH`: I need to work harder

or they correctly identify that

> `SSH`: late-stage capitalism is not compatible with Life, Liberty and the pursuit of Happiness, so I should stop voting for late-stage capitalists with my money and ballots and instead vote for the people who let me pursue my passions
