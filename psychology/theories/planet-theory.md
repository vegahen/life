...
```yaml
inspiration:
  urls: https://en.wikipedia.org/wiki/Men_Are_from_Mars,_Women_Are_from_Venus
```
...
### [All Too Well (10 Minute Version) (Taylor's Version) (From The Vault)](/media/music/all-too-well-10-minute-version-taylors-version-from-the-vault.md)

```yaml
type: reference
identifier:
  url: https://www.imdb.com/title/tt9603082
timestamp: 00:03:38
```

[YouTube](https://youtu.be/tollGa3S0o8?t=218)

When you try to force her to move to your own planet, but all she really wanted to do was share her feelings on her own.
